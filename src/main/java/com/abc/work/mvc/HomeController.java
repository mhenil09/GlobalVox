...
public class HomeController {
    ...
    public String processCust(@Valid @ModelAttribute("cust") Customer cust, BindingResult br){
        if(br.hasErrors()){
            return "cust_form";
        }else{
            SessionFactory sf = new Configuration().configure("hibernate.cfg.xml").addAnnotatedClass(Customer.class).buildSessionFactory();
